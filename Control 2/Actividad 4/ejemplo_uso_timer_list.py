...
import socket
    ...
    def send_using_stop_and_wait(self, message):
        ...
        data_to_send = swcc.SlidingWindow(1, [message_length] + data_list, initial_seq)
        wnd_index = 0
        ...
        # y para manejar un socket no bloqueante vamos a necesitar un while True
        while True:
            try:
                ...
                if len(timeouts) > 0:
                    self.socket_udp.sendto(current_segment, self.destination_address)
